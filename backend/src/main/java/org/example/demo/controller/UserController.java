...
public class UserController {
    ...
    public ResponseEntity<ResponseObject> login(
        ...
        TokenRecord jwtTokenRecord = tokenService.addToken(userDetail, token,isMobileDevice(userAgent));
    ...
    public ResponseEntity<ResponseObject> refreshToken(
        ...
        TokenRecord jwtTokenRecord = tokenService.refreshToken(refreshTokenDTO.getRefreshToken(), userDetail);
        LoginResponse loginResponse = LoginResponse.builder()
